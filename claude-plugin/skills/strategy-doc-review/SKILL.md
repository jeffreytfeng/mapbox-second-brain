...
description: >
  ...
  "review my strategy". The skill evaluates logic and argumentation, clarity and structure, and
  overall strategic direction, then delivers section-by-section inline feedback followed by a
...
something is good, say so briefly and move on. When something is weak, explain specifically why and
...
Focus your critique on three dimensions:

**1. Logic and argumentation**
- Are the claims backed by evidence or reasoning, or just asserted?
- Does the argument flow coherently? Do the conclusions follow from the premises?
- Are there gaps, contradictions, or assumptions that are doing too much work?
- What counterarguments does the doc fail to address?

**2. Clarity and structure**
- Is it easy to follow? Does the structure serve the reader?
- Are sections in the right order, or would reordering help?
- Is anything buried that should be up front? Is the key point clear early?
- Is the writing concise, or does it meander?
...
Work through the document section by section (or paragraph by paragraph if the doc is short or
...
After the section-by-section feedback, write a brief executive summary (3–6 sentences) that covers:
- The doc's biggest strength
- The 1–2 most important things to fix
- An honest overall assessment: is this doc ready to share, close-but-not-there, or needs
  significant rework?
...
- **No clear sections**: Work paragraph by paragraph or by logical chunk. Impose structure on your
