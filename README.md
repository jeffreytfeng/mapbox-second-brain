...
- **12 skills** packaged as a local Claude Code plugin: `/update`, `/learn`, `/sync`, `/retro`, `/morning-brief`, `/my-voice`, `/meeting-prep`, `/weekly-update`, `/draft-prd-section`, `/draft-prfaq-section`, `/synthesize-research`, `/strategy-doc-review`
...
└── claude-plugin/        # → ~/.claude/plugins/local/mapbox-second-brain/
    ...
    │   ├── marketplace.json
    │   └── plugin.json
    ├── skills/           # 12 skills (SKILL.md per skill)
    └── hooks/
        ├── hooks.json
